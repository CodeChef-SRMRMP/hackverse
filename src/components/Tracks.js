...
const Tracks = () => {
  ...
  return (
    <div className="m-10 mx-5 md:mx-10 lg:mx-20">
      ...
      <div className="bg-black/60 mt-5 flex flex-wrap gap-5 items-end justify-center md:justify-between lg:justify-evenly px-10 lg:px-20 backdrop-blur-xl rounded-md text-white p-10">
